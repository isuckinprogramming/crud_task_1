...
(101, 'Neena', 'Kochhar', 'N.Kochhar@email.com', 'NKOCHHAR', '515.123.4568', '1989-09-21', 'AD_VP', 17000, NULL, 100, 90),
...
--
DELIMITER $$
CREATE TRIGGER `updatetotjobs1` BEFORE INSERT ON `jobs` FOR EACH ROW BEGIN
